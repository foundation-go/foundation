...
- 🌉 **Running Modes**: Adapt Foundation to cater to diverse operational requirements:
  ...
  - **Outbox Producer Mode**: A mode to run a Kafka producer that reads messages from the database and publishes them to Kafka. _This is useful for implementing the transactional outbox pattern._
