...
var file_examples_clubchat_protos_chats_objects_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x3d,
	0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x69, 0x2d,
	0x6e, 0x61, 0x74, 0x2f, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x65,
	0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x2f, 0x63, 0x6c, 0x75, 0x62, 0x63, 0x68, 0x61, 0x74,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x63, 0x68, 0x61, 0x74, 0x73, 0x62, 0x06, 0x70,
...
var file_examples_clubchat_protos_chats_objects_proto_goTypes = []interface{}{
...
func file_examples_clubchat_protos_chats_objects_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_examples_clubchat_protos_chats_objects_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Chat); i {
			case 0:
				return &v.state
			case 1:
		...
		file_examples_clubchat_protos_chats_objects_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_examples_clubchat_protos_chats_objects_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
